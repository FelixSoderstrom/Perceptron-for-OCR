# Bugs encountered in notebook
While running the notebook that claude refactored for me I saved all the tracebacks.
...
This is when drawing my own digit



## Cell 24
AttributeError: 'MNISTClassifier' object has no attribute 'fc_layers'

We probably need to create another property wrappeed method that returns the fc layers in a list.


## Cell 28

Traceback: AttributeError: 'MNISTClassifier' object has no attribute 'conv_layers'

This is the same reason as in cell 22.
This should be fixed with the method created mentioned above.
